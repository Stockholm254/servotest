...
if Img_switch == 2: # Absorption imaging
    ...
    times_IMG = Imaging(times, 2, Img_prep_time_us*Unit.us(), Img_TOF_ms*Unit.ms(), Img_time_us*Unit.us(), Img_drop_time_ms*Unit.ms(), Img_MOT_pwr, 0., None, None, blue_img_ttl=Blue_img_ttl, blue_img_pwr=PRB_Ctrl_pwr)
    VImg_pwr.SetInterval(times_IMG, Img_ABS_pwr)
    # Elliptical lattice

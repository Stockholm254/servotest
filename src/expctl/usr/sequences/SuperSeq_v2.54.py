...
Trans_GDEP_ttl = 1
Trans_GDEP_pwr = 5
#MV(ParamHeat_freq_kHz, min=10, max=3000000.0, init=110, inc=0.1, digits=2)
# Tab:dRSC
dRSC_switch   = 1
dRSC1_repetitions = 1
dRSC_Dur_ms   = 5
...
# DDS PDH seq
RP_trans_a.SetSteadyStateValue(80*Unit.MHz())
RP_trans_b.SetSteadyStateValue(80*Unit.MHz())

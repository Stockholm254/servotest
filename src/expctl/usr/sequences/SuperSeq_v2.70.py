...
from expctl.dat.all_channels import ODT2_ttl, Sacher2_ttl
...
DMD_Tilt_X = -0.3
DMD_Tilt_Y = 0.35
#Final settings makeNPC((0.6,0.55), 0, [0], 75, center=(90,75), defocus=-0.6, tilt=(-0.3,0.35),intensities=[6000,1,2,3,4,1]), 
...
# DMD
DMD_waist_x.SetInterval(times_Init, DMD_Waist_X)
DMD_waist_y.SetInterval(times_Init, DMD_Waist_Y)
DMD_p.SetInterval(times_Init, DMD_P)
DMD_l.SetInterval(times_Init, DMD_L)
DMD_rotation.SetInterval(times_Init, DMD_Rotation)
...
# DMD
DMD_waist_x.SetSteadyStateValue(DMD_Waist_X)
DMD_waist_y.SetSteadyStateValue(DMD_Waist_Y)
DMD_p.SetSteadyStateValue(DMD_P)
DMD_l.SetSteadyStateValue(DMD_L)
DMD_rotation.SetSteadyStateValue(DMD_Rotation)

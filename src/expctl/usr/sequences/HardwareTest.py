...
# Tab:Trigger_time
MV(Trigger_time_us, min=1., max=100., init=10., digits=3)
...
# Tab:Analog_freq
MV(Analog_val_time_ms, min=0., max=2000., init=1000., inc=10., digits=4)
...
trigger = times.append(Trigger_time_us*Units.us(), name="Trigger")
...
dch01mod = [[0, 0, 0, 1], [0.5/DCh01_MHz/Units.MHz(), 1, 0.5/DCh01_MHz/Units.MHz(), 0], [0.5/DCh01_MHz/Units.MHz(), 0, 1./DCh01_MHz/Units.MHz(), 0]]
dch02mod = [[0, 0, 0, 1], [0.5/DCh02_MHz/Units.MHz(), 1, 0.5/DCh02_MHz/Units.MHz(), 0], [0.5/DCh02_MHz/Units.MHz(), 0, 1./DCh02_MHz/Units.MHz(), 0]]
dch03mod = [[0, 0, 0, 1], [0.5/DCh03_MHz/Units.MHz(), 1, 0.5/DCh03_MHz/Units.MHz(), 0], [0.5/DCh03_MHz/Units.MHz(), 0, 1./DCh03_MHz/Units.MHz(), 0]]
dch04mod = [[0, 0, 0, 1], [0.5/DCh04_MHz/Units.MHz(), 1, 0.5/DCh04_MHz/Units.MHz(), 0], [0.5/DCh04_MHz/Units.MHz(), 0, 1./DCh04_MHz/Units.MHz(), 0]]
dch05mod = [[0, 0, 0, 1], [0.5/DCh05_MHz/Units.MHz(), 1, 0.5/DCh05_MHz/Units.MHz(), 0], [0.5/DCh05_MHz/Units.MHz(), 0, 1./DCh05_MHz/Units.MHz(), 0]]
dch06mod = [[0, 0, 0, 1], [0.5/DCh06_MHz/Units.MHz(), 1, 0.5/DCh06_MHz/Units.MHz(), 0], [0.5/DCh06_MHz/Units.MHz(), 0, 1./DCh06_MHz/Units.MHz(), 0]]
dch07mod = [[0, 0, 0, 1], [0.5/DCh07_MHz/Units.MHz(), 1, 0.5/DCh07_MHz/Units.MHz(), 0], [0.5/DCh07_MHz/Units.MHz(), 0, 1./DCh07_MHz/Units.MHz(), 0]]
dch08mod = [[0, 0, 0, 1], [0.5/DCh08_MHz/Units.MHz(), 1, 0.5/DCh08_MHz/Units.MHz(), 0], [0.5/DCh08_MHz/Units.MHz(), 0, 1./DCh08_MHz/Units.MHz(), 0]]
dch09mod = [[0, 0, 0, 1], [0.5/DCh09_MHz/Units.MHz(), 1, 0.5/DCh09_MHz/Units.MHz(), 0], [0.5/DCh09_MHz/Units.MHz(), 0, 1./DCh09_MHz/Units.MHz(), 0]]
dch10mod = [[0, 0, 0, 1], [0.5/DCh10_MHz/Units.MHz(), 1, 0.5/DCh10_MHz/Units.MHz(), 0], [0.5/DCh10_MHz/Units.MHz(), 0, 1./DCh10_MHz/Units.MHz(), 0]]
dch11mod = [[0, 0, 0, 1], [0.5/DCh11_MHz/Units.MHz(), 1, 0.5/DCh11_MHz/Units.MHz(), 0], [0.5/DCh11_MHz/Units.MHz(), 0, 1./DCh11_MHz/Units.MHz(), 0]]
dch12mod = [[0, 0, 0, 1], [0.5/DCh12_MHz/Units.MHz(), 1, 0.5/DCh12_MHz/Units.MHz(), 0], [0.5/DCh12_MHz/Units.MHz(), 0, 1./DCh12_MHz/Units.MHz(), 0]]
dch13mod = [[0, 0, 0, 1], [0.5/DCh13_MHz/Units.MHz(), 1, 0.5/DCh13_MHz/Units.MHz(), 0], [0.5/DCh13_MHz/Units.MHz(), 0, 1./DCh13_MHz/Units.MHz(), 0]]
dch14mod = [[0, 0, 0, 1], [0.5/DCh14_MHz/Units.MHz(), 1, 0.5/DCh14_MHz/Units.MHz(), 0], [0.5/DCh14_MHz/Units.MHz(), 0, 1./DCh14_MHz/Units.MHz(), 0]]
...
ach00mod = [[0, -1, 0.5/ACh00_kHz/Units.kHz(), 1], [0.5/ACh00_kHz/Units.kHz(), 1, 1./ACh00_kHz/Units.kHz(), -1]]
ach01mod = [[0, -1, 0.5/ACh01_kHz/Units.kHz(), 1], [0.5/ACh01_kHz/Units.kHz(), 1, 1./ACh01_kHz/Units.kHz(), -1]]
ach02mod = [[0, -1, 0.5/ACh02_kHz/Units.kHz(), 1], [0.5/ACh02_kHz/Units.kHz(), 1, 1./ACh02_kHz/Units.kHz(), -1]]
ach03mod = [[0, -1, 0.5/ACh03_kHz/Units.kHz(), 1], [0.5/ACh03_kHz/Units.kHz(), 1, 1./ACh03_kHz/Units.kHz(), -1]]
ach04mod = [[0, -1, 0.5/ACh04_kHz/Units.kHz(), 1], [0.5/ACh04_kHz/Units.kHz(), 1, 1./ACh04_kHz/Units.kHz(), -1]]
ach05mod = [[0, -1, 0.5/ACh05_kHz/Units.kHz(), 1], [0.5/ACh05_kHz/Units.kHz(), 1, 1./ACh05_kHz/Units.kHz(), -1]]
ach06mod = [[0, -1, 0.5/ACh06_kHz/Units.kHz(), 1], [0.5/ACh06_kHz/Units.kHz(), 1, 1./ACh06_kHz/Units.kHz(), -1]]
ach07mod = [[0, -1, 0.5/ACh07_kHz/Units.kHz(), 1], [0.5/ACh07_kHz/Units.kHz(), 1, 1./ACh07_kHz/Units.kHz(), -1]]
ach08mod = [[0, -1, 0.5/ACh08_kHz/Units.kHz(), 1], [0.5/ACh08_kHz/Units.kHz(), 1, 1./ACh08_kHz/Units.kHz(), -1]]
ach09mod = [[0, -1, 0.5/ACh09_kHz/Units.kHz(), 1], [0.5/ACh09_kHz/Units.kHz(), 1, 1./ACh09_kHz/Units.kHz(), -1]]
ach10mod = [[0, -1, 0.5/ACh10_kHz/Units.kHz(), 1], [0.5/ACh10_kHz/Units.kHz(), 1, 1./ACh10_kHz/Units.kHz(), -1]]
ach11mod = [[0, -1, 0.5/ACh11_kHz/Units.kHz(), 1], [0.5/ACh11_kHz/Units.kHz(), 1, 1./ACh11_kHz/Units.kHz(), -1]]
ach12mod = [[0, -1, 0.5/ACh12_kHz/Units.kHz(), 1], [0.5/ACh12_kHz/Units.kHz(), 1, 1./ACh12_kHz/Units.kHz(), -1]]
ach13mod = [[0, -1, 0.5/ACh13_kHz/Units.kHz(), 1], [0.5/ACh13_kHz/Units.kHz(), 1, 1./ACh13_kHz/Units.kHz(), -1]]
ach14mod = [[0, -1, 0.5/ACh14_kHz/Units.kHz(), 1], [0.5/ACh14_kHz/Units.kHz(), 1, 1./ACh14_kHz/Units.kHz(), -1]]
ach15mod = [[0, -1, 0.5/ACh15_kHz/Units.kHz(), 1], [0.5/ACh15_kHz/Units.kHz(), 1, 1./ACh15_kHz/Units.kHz(), -1]]

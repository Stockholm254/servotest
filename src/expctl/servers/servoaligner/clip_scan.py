...
FOLDER = "/home/rydpiservo/servodata/servorecover1/"
...
def scan_and_analyze(ITER_NUM,POS_MASK):
    # N_pts = 100
    N_pts = 100
    ...
    print(popt)
    print(sigmas)
    np.savez("{}{}_popt.npz".format(FOLDER,fileName),popt=popt,mu=mu,cov=cov,sigmas=sigmas)
...
if __name__ == "__main__":
    for ITER_NUM in range(100):
        for POS_MASK in [B_X_XDOT_MASK,B_Y_YDOT_MASK]:
            print(cf0([0,0,0,0,0,0,0,0]))
            time.sleep(1)
            scan_and_analyze(ITER_NUM,POS_MASK)
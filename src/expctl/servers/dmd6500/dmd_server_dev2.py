...
class DMDWindow:
    def __init__(self, fullscreen=True, width=1920, height=1080):
        ...
        d=10
        angle_deg = 60
        self.dmd = DLP6500(sharpness=a, period=d, angle=angle_deg, beta_deg=25.0)
    ...
    def compute_patterns_phasemap(self):
        ...
        Nphase = 5
        wprb = 30
        xprb = np.linspace(-width//2+100 + wprb, width//2 - wprb -100, Nx)
        yprb = np.linspace(-height//2 +100 + wprb, height//2 - wprb - 100, Ny)

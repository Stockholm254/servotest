...
class Camera:
    ...
    def get_image(self, wait=PySpin.EVENT_TIMEOUT_INFINITE):
    ...
    def get_array(self, wait=PySpin.EVENT_TIMEOUT_INFINITE, get_chunk=False):
        ...
        if get_chunk:
            ...
            img.Release()
            return img_array, (id, time_stamp)

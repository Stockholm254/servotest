...
server = Server('PTIn1', 60625)
server.message = fullpath + '\n'
server.message += '===========================================\n'
server.message += '==         Photon Timer Server 2         ==\n'
server.message += '===========================================\n'
...
pll = ok.okCPLL22150()
# code = r"C:\ExperimentSoftwares\Control_Suite_X\servers\FPGA_bit_file\PhotonTimers.bit"   # normal, 128 ms timer)
# code = r"C:\ExperimentSoftwares\Control_Suite_X\servers\FPGA_bit_file\PhotonTimers_ClockJP2_04.bit"
# code = r"C:\ExperimentSoftwares\Control_Suite_X\servers\FPGA_bit_file\PT_intDelays_intClk_3.bit"
code = r"C:\ExperimentSoftwares\Control_Suite_X\servers\FPGA_bit_file\PT_intDelays_sameDL_extClk.bit"
...
def RunServer(seq, autostart=0):
	...
	chan = seq.getChannelByName("Photon Timer 2")
	thehardwarevalues = chan.GetHardwareValues()
	save_switch_chan = seq.getChannelByName("Photon Timer 2 Save")
...
def Acquire(T, SeqFolderName='', SeqRunName='michael', save=0):
	...
	if save == 1:
		...
		f = open(full_dir+"PT2"+SeqRunName+'.bin', 'wb')

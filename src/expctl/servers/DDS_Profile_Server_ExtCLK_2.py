#!/usr/bin/python
#import servers.DDS_server.ok as ok
import time
import math
...
FPGAsn = '1452000AQ4' #This must match the S/N of the FPGA inside the PDH DDS box. Can find the serial number via the Opal Kelly FrontPanel interface.

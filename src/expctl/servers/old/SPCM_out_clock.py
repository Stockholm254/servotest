...
server.message += '===========================================\n'
server.message += '==         Photon Counter Server 1       ==\n'
server.message += '===========================================\n'
...
code = r"C:\ExperimentSoftwares\Control_Suite_X\servers\FPGA_bit_file\counters.bit"
          ...
          try:
            ...
            if acquire_data == 1:
              ...
              if save_data == 1:
                ...
                SaveDataWithCLK(server.seq.foldername, server.seq.runname, data)
          except:

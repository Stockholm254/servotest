...
digital_seq1, analog_seq1, cam, dds_1, dds_pdh, dds_2, photon_timer, photon_timer_2, photon_timer_3, photon_counter, lb_1, lb_2, lb_3 = all_sequences # WE DO IT IN THIS ORDER SO THAT ONE CANNOT GET AWAY WITH CREATING A NAMED SEQUENCE WHICH IS NOT IN THE ARRAY OF ALL SEQUENCES!!
...
MWaves_ttl    = digital_seq1.newChannel(29, "Microwaves TTL",   system='MWaves',  steady_state_value=0, max_value=1, graph=1)
...
LB1_freq  = lb_1.newChannel(0, "Lab Brick 1 Freq",  system='MWaves', steady_state_value=7500, max_value=10000, graph=1) # transformation handled in server
LB1_pow   = lb_1.newChannel(1, "Lab Brick 1 Power", system='MWaves', steady_state_value=0,   max_value=10,    graph=1) # transformation handled in server
LB1_ttl   = lb_1.newChannel(2, "Lab Brick 1 TTL",   system='MWaves', steady_state_value=1,   max_value=1,   graph=1) # transformation handled in server
